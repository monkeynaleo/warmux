...
class Globals {
	...
	// Should be zip file
	public static String DataDownloadUrl = "!Data|http://download.gna.org/warmux/android/android-data-11.04.zip^!Data2|http://download.gna.org/warmux/android/android-data-11.04.1.zip";
