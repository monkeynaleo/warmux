...
class Globals {
  ...
  // Should be zip file
  public static String DataDownloadUrl = "Game data is 42 MB|http://download.gna.org/wormux/android-data-0.9.3.zip"; // This string is autogenerated by ChangeAppSettings.sh, do not change spaces amount
