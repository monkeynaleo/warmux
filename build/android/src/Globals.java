...
class Globals {
  ...
  // Should be zip file
  public static String DataDownloadUrl = "Game data is 42 MB|http://download.gna.org/warmux/android/android-data-svn.zip"; // This string is autogenerated by ChangeAppSettings.sh, do not change spaces amount
