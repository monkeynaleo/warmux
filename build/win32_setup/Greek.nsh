...
!define WORMUX_DESC             "Εγκατάσταση του παιχνιδιού Wormux έκδοση ${WORMUX_VERSION}"
!define WORMUX_BOTTOM_TEXT      "Το ${WORMUX_TITLE} είναι διαθέσιμο υπό την άδεια GNU General Public License (GPL). Το κείμενο της άδειας παρέχεται σε μία απολύτως ενημερωτική βάση. $_CLICK"
!define WORMUX_BUTTON           "Επόμενο >"

; Components Page
!define WORMUX_SHORTCUTS_DESC   "Δημιουργία συντομεύσεων"
!define WORMUX_DESKTOP_SC_DESC  "Τοποθέτηση συντόμευσης στην επιφάνεια εργασίας για την έναρξη του Wormux"
...
!define WORMUX_PDF_SC_DESC      "Εγκατάσταση οδηγιών (PDF)"
