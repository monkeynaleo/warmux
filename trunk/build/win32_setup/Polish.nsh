...
!define WARMUX_DESC             "Instalacja gry Warmux w wersji ${WARMUX_VERSION}"
!define WARMUX_BOTTOM_TEXT      "${WARMUX_TITLE} - rozpowszechniany na licencji GNU General Public License (GPL). $_CLICK"
...
!define WARMUX_CONFIG_SC_DESC   "Skrót do folderu konfiguracji u¿ytkownika"
!define WARMUX_PDF_SC_DESC      "Zainstaluj podrêczniki w formacie PDF"

!define WARMUX_VISIT            "OdwiedŸ stronê WWW projektu Warmux"
