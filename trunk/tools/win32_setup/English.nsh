...
!define WORMUX_BOTTOM_TEXT      "${WORMUX_TITLE} is licensed under GNU General Public License (GPL). $_CLICK"
!define WORMUX_BUTTON           "Next >"

!define WORMUX_SHORTCUTS_DESC   "Install shortcuts at various locations"
!define WORMUX_DESKTOP_SC_DESC  "Place a shortcut on the desktop to run Wormux"
